...
class RegressionTree:
    ...
    def __init__(self, dataset, predictorVariables, responseVariable, max_depth, test_size_percentage):
        ...
        if test_size_percentage == 0:
            ...
            predictor_train, predictor_test, response_train, response_test = model_selection.train_test_split \
                (dataset[predictorVariables], dataset[responseVariable], test_size=test_size_percentage)
