...
crimeDataset = pd.read_csv("Regression/Datasets/crimeDataset.data")
print("Crime Model:")
...
autoCrimeDataset = pd.read_csv("Regression/Datasets/crimeDataset.data")
...
airfoilNoiseDataset = pd.read_table("Regression/Datasets/airfoilNoiseDataset.dat")
...
autoAirfoilNoiseDataset = pd.read_table("Regression/Datasets/airfoilNoiseDataset.dat")
...
studentDataset = pd.read_csv("Regression/Datasets/student-mat.csv", sep=";")
print("Student Model:")
studentModel = LinearRegressionModel(dataset=studentDataset,
                                     ...
                                     test_size_percentage=0.1,
                                     target_accuracy=.9)
# PlotUtil.plot(x_data=studentDataset["absences"], y_data=studentDataset["G3"], y_label="Final Grade")

autoStudentDataset = pd.read_csv("Regression/Datasets/student-mat.csv", sep=";")
...
singleVarDataset = pd.read_csv("Regression/Datasets/single_var_lin_reg.csv")
...
singleVarTestDataset = pd.read_csv("Regression/Datasets/single_var_lin_reg_test.csv")
