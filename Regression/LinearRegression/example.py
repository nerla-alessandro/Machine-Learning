...
PlotUtil.plot(x_data=crimeDataset["RacePctBlack"], y_data=crimeDataset["MedIncome"], x_label="Black % of Population", y_label="Median Income Normalized")
PlotUtil.plot(x_data=crimeDataset["RacePctWhite"], y_data=crimeDataset["MedIncome"], x_label="White % of Population", y_label="Median Income Normalized")
